...
SinglyLinkedListNode *mergeLists(SinglyLinkedListNode *head_list1, SinglyLinkedListNode *head_list2)
{
    ...
    if (head_list2 == nullptr)
    {
        return head_list1;
    }
    SinglyLinkedListNode *mergedHead = nullptr;
    SinglyLinkedListNode *mergedTail = nullptr;

    if (head_list1->data <= head_list2->data)
    {
        mergedHead = head_list1;
        head_list1 = head_list1->next;
    }
    else
    {
        mergedHead = head_list2;
    ...
    if (head_list1 != nullptr)
    {
        mergedTail->next = head_list1;
    }
    if (head_list2 != nullptr)
    {
        mergedTail->next = head_list2;
    }
    return mergedHead;
}
int main()
